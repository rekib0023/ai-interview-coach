...
function getStatusColor(status: AssessmentStatus) {
  switch (status) {
    case "created":
...
export default function AssessmentPage() {
  ...
  const {
    ...
    isLoading,
    refetch,
  } = useAssessments(1, 10, undefined, !authLoading && !!user);
    ...
    >
      ...
      >
        <div>
          ...
          <p className="text-muted-foreground">
            Start a new assessment or continue a previous one
          </p>
        </div>
      ...
      {showForm && (
        <motion.div variants={fadeInUp} initial="hidden" animate="visible">
          <DashboardCard
            ...
            description="Configure your assessment session"
      ...
      <motion.div variants={fadeInUp}>
        <DashboardCard
          ...
          description={`${assessmentsData?.total || 0} total assessments`}
          icon={<ListChecks className="h-4 w-4 text-primary" />}
          action={
            <Link
              href="/assessment?page=1"
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="mb-4 text-sm text-muted-foreground">
                Start your first assessment to begin improving
              </p>
