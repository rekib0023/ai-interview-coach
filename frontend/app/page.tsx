...
import { FloatingDataElement, ParallaxSection } from "@/components/landing/parallax-section";
    ...
    >
      ...
      <main className="relative z-10">
        ...
        <div className="fixed inset-0 pointer-events-none overflow-hidden select-none">
          ...
          />
          <FloatingDataElement
            className="top-[40%] right-0 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl opacity-20"
            depth={1.2}
            containerRef={containerRef}
          />
           <FloatingDataElement
            className="bottom-20 left-[20%] w-72 h-72 bg-emerald-500/10 rounded-full blur-3xl opacity-20"
            depth={0.8}
            containerRef={containerRef}
          />
        </div>
        ...
        <ParallaxSection offset={30} direction={-1} className="py-8" containerRef={containerRef}>
           <Stats />
        </ParallaxSection>
        ...
        <ParallaxSection offset={40} direction={-1} className="bg-slate-50/50 dark:bg-slate-900/50" containerRef={containerRef}>
          <HowItWorks />
        </ParallaxSection>
        ...
        <ParallaxSection offset={20} direction={1} className="pb-20" containerRef={containerRef}>
          <CTA />
        </ParallaxSection>
      </main>
